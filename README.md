...
A collection of open-source Python modules developed as part of the **Secuditor project** is available in the **[open scripts](/open-scripts)** folder, licensed under the [MIT License](/open-scripts/LICENSE.txt) (applicable only to this folder).
