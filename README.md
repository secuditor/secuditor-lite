...
Analyses and reports generated by the application are stored locally on your device, in the same folder where the software resides or in other local application folders used for logs and cache.
